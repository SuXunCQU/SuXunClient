 ...
 */
class IncidentUpdate extends PureComponent {
    ...
    render() {
        const {searchTypes, incident} = this.state;
        ...
        console.log(incident && incident.lost_name);
        return (
            <Card title={title}>
                <Form
                    {...formItemLayout}
                            ...
                            <Item label='走失者姓名'>

                                {
                                    getFieldDecorator('theLostName', {
                                        initialValue: incident && incident.lost_name,
                                        rules: [
...
export default Form.create()(IncidentUpdate)
